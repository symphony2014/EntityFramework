...
{
    public class RelationalPropertyMappingConvention : PropertyMappingConvention
    {
        private readonly IRelationalTypeMapper _typeMapper;

        public RelationalPropertyMappingConvention([NotNull] IRelationalTypeMapper typeMapper)
        {
